...
?>
		...
		<footer class="container-fluid p-a-1 footer">
		...
		<div class="triangulo"></div>
				...
				<div class="col-xs-12 col-md-4 offset-md-4">
					...
					<form id="form-contact" method="post" class="m-y-1">
						...
						<div class="form-group m-a-0">
						    ...
						    <textarea name="asunto" name="asunto" placeholder="Comentarios" class="form-control"></textarea>
			...
			<div class="container">
				...
				<div class="col-xs-12 col-md-4">
					...
					<p class="text-blanco text-xs-center m-a-0" style="line-height: 1.2rem;">info@pregelato.com <br> pregelatocolombia@gmail.com</p>
				...
				<div class="col-xs-12 col-md-4">
					...
					<p class="text-blanco text-xs-center m-a-0" style="line-height: 1.2rem;">Tel: +57(2) 327 5806 <br> Cels. (57) 316 619 9594 - (57) 318 342 3256</p>
...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#menu-toggle").click(function(){
			...
			if (redesShow==1) {
				$(".redes").removeClass("hidden-sm-down");
				redesShow = 0;
			}else{
				$(".redes").addClass("hidden-sm-down");
				redesShow = 1;
			}			
		})
