...
<head>
	...
	<?php endif; ?>
	<link rel="stylesheet" type="text/css" href="<?=bloginfo('siteurl')?>/css/bootstrap.css">
	<link rel="stylesheet" type="text/css" href="<?=bloginfo('siteurl')?>/css/font-awesome.min.css">
	<?php wp_head(); ?>	
</head>
